...
If you want to accept the next line of a suggestion, you will need to set a custom keyboard shortcut for the `Copilot: Apply Next Line of Completion to Editor` action. You can find this action in **Settings** > **Keymap** under **Plugins** > **GitHub Copilot**. For more information on setting custom keyboard shortcuts, see [AUTOTITLE](/copilot/configuring-github-copilot/configuring-github-copilot-in-your-environment).
